...
\begin{DoxyCompactList}\small\item\em Initialize the special registers in the I\+O-\/section (0x\+F\+F00-\/0x\+F\+F7F) of the memory model. \end{DoxyCompactList}\end{DoxyCompactItemize}
